...
class ProcessingFeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('ProcessingFee.index')->with('success', trans('all_trans.Success'));
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('ProcessingFee.index')->with('success', trans('all_trans.Update'));
        } catch (\Exception $e) {
            DB::rollback();
            return redirect()->back()->withErrors(['error' => $e->getMessage()]);
        }
