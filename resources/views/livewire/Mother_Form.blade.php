    ...
    <div style="display: none" class="row setup-content" id="step-2">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('all_trans.Name_Mother')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.Name_Mother_en')}}</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title">{{trans('all_trans.Job_Mother')}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="title">{{trans('all_trans.Job_Mother_en')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('all_trans.Nationality_Father_id')}}</label>
                ...
                @else
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="button"
                            wire:click="secondStepSubmit">{{trans('all_trans.Next')}}</button>
                @endif
            </div>
        </div>
    </div>
