    ...
    <div style="display: none" class="row setup-content" id="step-1">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('all_trans.TheEmail')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.Password')}}</label>
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">{{trans('all_trans.Name_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.Name_Father_en')}}</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title">{{trans('all_trans.Job_Father')}}</label>
                    ...
                    <div class="col-md-3">
                        <label for="title">{{trans('all_trans.Job_Father_en')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.National_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.Passport_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('all_trans.Phone_Father')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('all_trans.Nationality_Father_\id')}}</label>
                        <select class="custom-select my-1 mr-sm-2" wire:model="Nationality_Father_id">
                            <option selected>{{trans('all_trans.Choose')}}...</option>
                    ...
                    <div class="form-group col">
                        <label for="inputState">{{trans('all_trans.Blood_Type_Father_id')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">{{trans('all_trans.Religion_Father_id')}}</label>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">{{trans('all_trans.Address_Father')}}</label>
                ...
                @if($updateMode)
                    <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" wire:click="firstStepSubmit_edit"
                            type="button">{{trans('all_trans.Next')}}
                    </button>
                @else
