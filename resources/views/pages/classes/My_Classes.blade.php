    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" class="button x-small" data-toggle="modal" data-target="#exampleModal">
                {{ trans('all_trans.add_class') }}
            </button>
            <button type="button" class="button x-small" id="btn_delete_all">
                {{ trans('all_trans.delete_checkbox') }}
            </button>
            <br><br>
            ...
            <form action="{{ route('filter') }}" method="POST">
                ...
                <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                    ...
                    <option value="" selected disabled>{{ trans('all_trans.Search_By_Grade') }}</option>
                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('all_trans.Name_Grade') }}</th>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('classes.update', 'test') }}" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="Name"
                                                            class="mr-sm-2">{{ trans('all_trans.Name_class') }}
                                                        :</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en"
                                                            class="mr-sm-2">{{ trans('all_trans.Name_class_en') }}
                                                        :</label>
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="exampleFormControlTextarea1">{{ trans('all_trans.Name_Grade') }}
                                                    :</label>
                ...
                <form class=" row mb-30" action="{{ route('classes.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="repeater">
                            <div data-repeater-list="List_Classes">
                                <div data-repeater-item>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name_en"
                                                class="mr-sm-2">{{ trans('all_trans.Name_Grade') }}
                                                :</label>
                                            <div class="box">
                                        ...
                                        <div class="col">
                                            <label for="Name_en"
                                                class="mr-sm-2">{{ trans('all_trans.Processes') }}
                                                :</label>
                                            <input class="btn btn-danger btn-block" data-repeater-delete
                                                type="button" value="{{ trans('all_trans.Delete') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-20">
                                <div class="col-12">
                                    <input class="button" data-repeater-create type="button" value="{{ trans('all_trans.add_class') }}"/>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
