                ...
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <div>
                                    <abbr title="don't integrate with zoom ... but go to zoom and create meeting at take the information and return to add this information in the form"><a class="btn btn-success btn-sm" href="{{route('online_zoom.create')}}">اضافة حصة اوفلاين جديدة</a></abbr>
                                </div><br>
